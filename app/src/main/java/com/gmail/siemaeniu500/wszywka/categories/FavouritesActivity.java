...
public class FavouritesActivity extends Activity {
    ...
    ListView soundsList;
    public static SoundsAdapter soundAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FavouritesActivity.this, MainMenuActivity.class);
        ...
        soundsArray.add(new Sound("zeby_te_piwa_nie_zarazily_sie", "zeby te piwa", R.drawable.zeby_te_piwa_nie_zarazily_sie));
        ...
        Iterator<Sound> iter = soundsArray.iterator();
        while (iter.hasNext()) {

            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
            boolean favourite = prefs.getBoolean(iter.next().getPath(), false);
            if (favourite == false) {
                iter.remove();
            }

        }
        if (soundsArray.isEmpty() == true) {
            if (StartActivity.toast != null) {
                StartActivity.toast.cancel();
            }
            StartActivity.toast = Toast.makeText(this.getApplicationContext(), "Dodaj pierw swoje ulubione teksty :)",
                    Toast.LENGTH_SHORT);
        ...
        soundAdapter = new SoundsAdapter(FavouritesActivity.this, R.layout.row,
                soundsArray);
